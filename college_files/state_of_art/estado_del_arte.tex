...
se cita en \textcite{Pisco2020}, se puede sobreentender el mantenimiento
...
(Bishop, 2006  como se cita en Janiesch et al., 2021)
...
\begin{itemize}
  ...
  \item \textbf{No supervisado:}
    ...
    (Witten et al., 2011, como se cita en Singh et al., 2022)
  ...
  \item \textbf{Aprendizaje por refuerzo:}
    ...
    (Richard S Sutton y Andrew G Barto., 2018, como se cita en Chen et al., 2023)
    \end{displayquote}
...
(Esic Business \& Marketing School, 2020, como se cita en Bueno Munar L, 2022)
...
(Sanchez, 2019, como se cita en Bueno Munar, 2022)
...
\begin{itemize}
  \item \textbf{Phishing:}
    ...
    \begin{displayquote}
      ...
      (INCIBE, 2010, como se cita en Bueno Munar, 2022)
    \end{displayquote}
