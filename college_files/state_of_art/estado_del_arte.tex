...
funcionamiento en servidores y generadores de
imágenes
...
\begin{displayquote}
  ...
  hardware. \parencite[e.g.,][]{Janiesch2021}
\end{displayquote}
...
\begin{itemize}
  ...
  \item \textbf{Aprendizaje por refuerzo:}
    ...
    aprendizaje supervisado. \parencite[e.g.,][]{Janiesch2021}
    ...
    posibilidades. \parencite[e.g.,][]{Chen2023}
\end{itemize}
...
\begin{itemize}
  ...
  \item \textbf{Carding:}
    ...
    la clonación de tarjetas. \parencite[e.g.,][]{Mosquera2019}

  \item \textbf{Ofuscación:}
    \parencite[e.g.,][]{Aboaoja2022}
