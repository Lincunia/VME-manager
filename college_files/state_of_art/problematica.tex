...
En el estado actual de la seguridad, Hansen, et al. (2016) encontraron que el
número del malware incrementó en un 22.9\% cosa es preocupante asumiendo que con
el paso del tiempo, hay más personas interesadas en crear malware más
sofisticado para evitar su detección (como se cita en \cite{Aboaoja2022})
...
\begin{displayquote}
  ...
  sistema pertenezcan a la misma empresa. \parencite[e.g.,][]{Singh2022}
\end{displayquote}
...
La Ley 1273 de 2009 del código penal 
% Algún texto especial
Figura~\ref{fig:delitos}
