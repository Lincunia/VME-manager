...
\textcite{CanoMartinez2022} de que la seguridad de la información digital (en el
contexto de los colombianos) es primordial, ya que si es escasa, se pueden
generar desde efectos molestos hasta destructivos en el aspecto político,
económico, legal, etcétera:
...
\begin{displayquote}
  ...
  (Wakabayashi D, 2019, como se cita en \textcite{Banja2020})
\end{displayquote}
