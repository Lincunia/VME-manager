% This thing is copied from stackoverflow :P
...
\tikzset{
    ...
    matter/.style  ={
        rectangle,
        gminimum size=6mm, very thick, draw=red!70!black!40,
        top color=white,
        gbottom color=red!50!black!20, font=\itshape
    },
    level_1/.style ={
        ellipse,
        gnode distance=60pt, minimum size=6mm, very thick,
        draw=red!50!black!50,
        gtop color=white, bottom color=red!50!black!20, font=\itshape
    },
    level_2/.style={
        rectangle,
        gminimum size=6mm, font=\itshape, font=\scriptsize
    }
}
\tikzset{
